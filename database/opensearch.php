<?php
	...
	//
	// - ask the server to return Jfa-formatted search suggestions for authors whose last names
...
//		elseif (preg_match("/^json$/i", $recordSchema))
	...
	function searchSuggestions($cqlQuery, $query)
	{
		...
		if (preg_match("/^json$/i", $recordSchema)) // return Jfa-formatted search suggestions:
